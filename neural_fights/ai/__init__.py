...
_EXPORTS = {
    ...
    "PercepcaoMundo": ("neural_fights.ai.percepcao", "PercepcaoMundo"),
    "ObservacaoInimigo": ("neural_fights.ai.percepcao", "ObservacaoInimigo"),
    "construir_observacao": ("neural_fights.ai.percepcao", "construir_observacao"),
