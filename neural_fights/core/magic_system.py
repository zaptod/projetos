...
definições compartilhadas são sincronizadas de ``neural_fights.core.status_runtime`` abaixo;
...
from neural_fights.core.status_runtime import BUFF_EFFECT_RUNTIME, STATUS_RUNTIME, normalizar_efeito
