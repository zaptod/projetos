...
# Partículas
from neural_fights.effects.particles import (
    Particula,
    HitSpark,
    Shockwave,
    EncantamentoEffect,
...
# Impacto
from neural_fights.effects.impact import (
    ImpactFlash,
    MagicClash,
    BlockEffect,
    DashTrail,
...
# Visual/UI
from neural_fights.effects.visual import (
    FloatingText,
    Decal,
)

# === NOVO: Sistema de Animação de Movimento v8.0 ===
from neural_fights.effects.movement import (
...
from neural_fights.effects.audio import (
    AudioManager,
    play_sound,
    play_attack_sound,
    play_impact_sound,
