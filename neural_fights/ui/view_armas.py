...
from neural_fights.core import SKILL_DB
        ...
        try:
            ...
            if self.indice_em_edicao is not None:
                ...
                if not nome_original:
                    raise DataValidationError("arma original de edicao ausente")
                atualizar_arma(nome_original, nova)
                self.controller.lista_armas[self.indice_em_edicao] = nova
                self.indice_em_edicao = None
                self.nome_original_edicao = None
            else:
                lista_nova = [*self.controller.lista_armas, nova]
                salvar_lista_armas(lista_nova)
