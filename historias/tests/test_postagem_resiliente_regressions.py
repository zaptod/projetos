...
class ProximoBuildPulaMudoTests(unittest.TestCase):
    ...
    def test_video_so_no_tiktok_continua_na_fila_do_youtube(self):
        ...
        self.assertEqual("so_tk", self.m.proximo_build().id)
...
class FilaDoYouTubeContaSoOYouTubeTests(unittest.TestCase):

    def test_parte_que_so_foi_ao_tiktok_continua_pendente(self):
        ...
        self.assertEqual(["h:celular:p01"], [v.id for v in m.fila_de_historias()])
